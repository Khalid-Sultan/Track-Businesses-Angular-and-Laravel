<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
        <h1>Add Operating Sub Sector</h1>
        <form ng-submit="addOperatingSubSectors()">
    ...
    <div class="col-lg-8 col-lg-offset-2" style="margin-top: 2em">
        ...
        <uib-tabset type="pills">
            <uib-tab heading="Show all">
                <h3>All Operating Sub Sectors</h3>
                ...
                <div class="col-lg-offset-1">
                    <ul ng-repeat="list in allOperatingSubSectors" style="list-style-type: none;">
                        <li>
                            <div class="row">
                                <div class="col-md-4">
