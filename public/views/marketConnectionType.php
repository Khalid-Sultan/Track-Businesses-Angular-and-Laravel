<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
        <h1>Add Market Connection Type</h1>
        <form ng-submit="addMarketConnectionTypes()">
    ...
    <div class="col-lg-8 col-lg-offset-2" style="margin-top: 2em">
        ...
        <uib-tabset type="pills">
            <uib-tab heading="Show all">
                <h3>All Market Connection Types</h3>
                ...
                <div class="col-lg-offset-1">
                    <ul ng-repeat="list in allMarketConnectionTypes" style="list-style-type: none;">
                        <li>
                            <div class="row">
                                <div class="col-md-4">
