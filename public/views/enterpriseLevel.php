<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
        <h1>Add Enterprise Level</h1>
        <form ng-submit="addEnterpriseLevels()">
    ...
    <div class="col-lg-8 col-lg-offset-2" style="margin-top: 2em">
        ...
        <uib-tabset type="pills">
            <uib-tab heading="Show all">
                ...
                <div class="col-lg-offset-1">
                    <ul ng-repeat="list in allEnterpriseLevels" style="list-style-type: none;">
                        <li>
                            <div class="row">
                                <div class="col-md-4">
