<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
        <h1>Add Enterprise Architecture Source</h1>
        <form ng-submit="addEnterpriseArchitectureSources()">
    ...
    <div class="col-lg-8 col-lg-offset-2" style="margin-top: 2em">
        ...
        <uib-tabset type="pills">
            <uib-tab heading="Show all">
                <h3>All Enterprise Architecture Sources</h3>
                ...
                <div class="col-lg-offset-1">
                    <ul ng-repeat="list in allEnterpriseArchitectureSources" style="list-style-type: none;">
                        <li>
                            <div class="row">
                                <div class="col-md-4">
