<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
        <h1>Add Membership By EZ</h1>
        <form ng-submit="addMembershipByEZs()">
    ...
    <div class="col-lg-8 col-lg-offset-2" style="margin-top: 2em">
        ...
        <uib-tabset type="pills">
            <uib-tab heading="Show all">
                ...
                <div class="col-lg-offset-1">
                    <ul ng-repeat="list in allMembershipByEZs" style="list-style-type: none;">
                        <li>
                            <div class="row">
                                <div class="col-md-4">
